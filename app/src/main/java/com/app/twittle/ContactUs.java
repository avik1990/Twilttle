...
public class ContactUs extends AppCompatActivity implements View.OnClickListener {
    ...
    private void setData() {
        tv_address.setText(aboutUs.getContactData().getAddress());
        tv_email.setText(aboutUs.getContactData().getEmail());
        tv_contactno1.setText(aboutUs.getContactData().getContactNo1());
        tv_contactno2.setText(aboutUs.getContactData().getContactNo2());
        tv_whatsapp.setText(aboutUs.getContactData().getWhatsappNo());
    }
